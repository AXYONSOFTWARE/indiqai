...
import 'cadastro_v2_model.dart';
export 'cadastro_v2_model.dart';

class CadastroV2Widget extends StatefulWidget {
  const CadastroV2Widget({super.key});

  @override
  State<CadastroV2Widget> createState() => _CadastroV2WidgetState();
}

class _CadastroV2WidgetState extends State<CadastroV2Widget>
    with TickerProviderStateMixin {
  late CadastroV2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroV2Model());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 8.0, 0.0, 24.0),
                                        child: Text(
                                          'Entre agora e acompanhe seus novos pontos',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
