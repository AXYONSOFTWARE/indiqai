...
export 'cadastronull_model.dart';

class CadastronullWidget extends StatefulWidget {
  const CadastronullWidget({super.key});

  @override
  State<CadastronullWidget> createState() => _CadastronullWidgetState();
}

class _CadastronullWidgetState extends State<CadastronullWidget>
    with TickerProviderStateMixin {
  late CadastronullModel _model;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 24.0),
                                    child: Text(
                                      'São poucos dados necessários para garantir o seu prêmio',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.senhaConfirmarFocusNode,
                                        autofocus: false,
                                        obscureText:
