      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: wrapWithModel(
            model: _model.returndadaModel,
            updateCallback: () => setState(() {}),
            child: const ReturndadaWidget(),
          ),
          title: Padding(
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 8.0, 0.0, 12.0),
                                            child: Text(
                                              'By protecting and preserving our oceans, we can effectively reduce global warming as ',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
