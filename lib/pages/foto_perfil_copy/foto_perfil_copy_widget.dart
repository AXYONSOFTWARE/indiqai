                      ...
                      Padding(
                        ...
                        child: FutureBuilder<List<UsuariosRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UsuariosRow> fotoUsuariosRowList =
                                snapshot.data!;

                            final fotoUsuariosRow =
                                fotoUsuariosRowList.isNotEmpty
                                    ? fotoUsuariosRowList.first
                                    : null;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            if (_model.nomeCadastroTextController
                                                        .text !=
                                                    '') {
                                              context.goNamed('DetalhePremio');
                                            } else {
