...
import 'profile_modal_model.dart';
export 'profile_modal_model.dart';
...
class _ProfileModalWidgetState extends State<ProfileModalWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileModalModel());
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  context.pushNamedAuth(
                                      'cadastro', context.mounted);
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                                    color: const Color(0x50FB517A),
                                    borderRadius: BorderRadius.circular(12.0),
                                    border: Border.all(
                                      color: FlutterFlowTheme.of(context)
                                          .alternate,
