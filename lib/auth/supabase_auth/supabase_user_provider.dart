...
class IndiqAiSupabaseUser extends BaseAuthUser {
  IndiqAiSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> indiqAiSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = IndiqAiSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
